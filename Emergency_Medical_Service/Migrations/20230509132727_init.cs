        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Responds_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "CarId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Responds_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "DoctorId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Responds_Patients_PatientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Responds_CarId",
                table: "Responds",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_Responds_DoctorId",
                table: "Responds",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_Responds_PatientId",
                table: "Responds",
                column: "PatientId");
        }
